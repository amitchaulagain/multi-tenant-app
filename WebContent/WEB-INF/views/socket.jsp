...
<head>
    ...
    <link href="<c:url value="/resources/lib/bootstrap/css/bootstrap.css"/>"
          rel="stylesheet">
    <link href="<c:url value="/resources/common/portfolio.css"/>" rel="stylesheet">
    <link href="<c:url value="/resources/common/portfolio.css"/>" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="<c:url value="/resources/lib/html5shiv/dist/html5shiv.js"/>"></script>
    <![endif]-->
</head>
<body>
...
<script src="<c:url value="/resources/lib/knockout/knockout.js"/>"></script>

<script src="<c:url value="/resources/lib/sockjs/sockjs.js"/>"></script>

<script src="<c:url value="/resources/lib/stomp/lib/stomp.min.js"/>"></script>
<script src="<c:url value="/resources/portfolio.js"/>"></script>
...
<script type="text/javascript">
    (function () {
                ...
                appModel.pushNotification("You have successfully.");
